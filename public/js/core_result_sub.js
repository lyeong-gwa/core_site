...
let job_skill={
	...
	Night_walker:['00럭키세븐.png', '01쉐도우 배트.png', '02트리플 스로우.png', '03쿼드러플 스로우.png', '04스타더스트.png', '05퀸터플 스로우.png', '06다크니스 오멘.png', '07쉐도우 스티치.png', '08도미니언.png'],
	...
	Mikhail:['00소울 블레이드.png', '01로얄 가드.png', '02소울 드라이버.png', '03샤이닝 체이스,버티컬 샤이닝 체이스.png', '04소울 슬래시.png', '05소울 어썰트.png', '06샤이닝 크로스.png', '07데들리 차지.png', '08파이널 어택.png'],
	...
	Soul_Master:['00트리플 슬래시.png', '01사일런트 무브,라우드 러쉬.png', '02트레이스컷,섀도우 번.png', '03문 섀도우,라이트 플럭스.png', '04문크로스,선크로스.png', '05댄스 오브 문,스피딩 선셋.png', '06크레센트 디바이드,솔라 피어스.png', '07소울 페네트레이션.png', '08크로스 더 스틱스.png', '09솔루나 슬래시.png'],
	Striker:['00충아.png', '01섬광.png', '02회축.png', '03파도.png', '04승천.png', '05뇌성.png', '06질풍.png', '07섬멸.png', '08벽력.png', '09해신강림.png'],
	...
	Windbreaker:['00브리즈 애로우.png', '01페어리 턴.png', '02거스트 샷.png', '03트리플링 윔.png', '04서리바람의 군무.png', '05핀포인트 피어스.png', '06천공의 노래.png', '07스파이럴 볼텍스.png', '08몬순.png', '09스톰 브링어.png'],
	...
	Flame_Wizard:['00오비탈 플레임.png', '01플레임 바이트.png', '02플레임 볼텍스.png', '03이그니션.png', '04플레임 템페스타.png', '05마엘스트롬.png', '06블레이징 익스팅션.png', '07인페르노라이즈.png', '08카타클리즘.png', '09드래곤 슬레이브.png'],
